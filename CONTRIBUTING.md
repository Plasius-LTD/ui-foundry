# Contributing to @plasius/ui-foundry
...
`@plasius/ui-foundry` provides a modern component and UI utilities library for React and TypeScript:

- A set of reusable, accessible React components,
- Utility hooks and helpers for building consistent UIs,
- Strong typing for safe composition and theming,
- Design-system integration for consistent look and feel across projects.

Contributions typically fall into: new components, hook utilities, accessibility improvements, design-system features, documentation, and tooling quality.
